...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    message = (
        ...
        "/arep\_em <emoji> <replacement> - 𝗔𝗱𝗱 𝗲𝗺𝗼𝗷𝗶 𝗿𝗲𝗽𝗹𝗮𝗰𝗲𝗺𝗲𝗻𝘁\n"
        "/rrep\_em <emoji> - 𝗥𝗲𝗺𝗼𝘃𝗲 𝗲𝗺𝗼𝗷𝗶 𝗿𝗲𝗽𝗹𝗮𝗰𝗲𝗺𝗲𝗻𝘁\n\n"
        "📥 𝗥𝗲𝗾𝘂𝗲𝘀𝘁 𝗦𝘆𝘀𝘁𝗲𝗺:\n"
        "/request <group\_id> - 𝗥𝗲𝗾𝘂𝗲𝘀𝘁 𝗴𝗿𝗼𝘂𝗽 𝗮𝗱𝗱𝗶𝘁𝗶𝗼𝗻 (𝗨𝘀𝗲𝗿𝘀)❄️\n"
        "/approve <user\_id> - 𝗔𝗽𝗽𝗿𝗼𝘃𝗲 𝗿𝗲𝗾𝘂𝗲𝘀𝘁 (𝗔𝗱𝗺𝗶𝗻𝘀)❄️\n"
